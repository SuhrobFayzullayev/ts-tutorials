...
let a: unknown = 5; // any ga teng bolgan lekin havfsiz bolgan type hisoblanadi
...
let b: number = <number>a; // bu holatda a variable number typega o'girilib keyin b variablega o'zlashtirildi
