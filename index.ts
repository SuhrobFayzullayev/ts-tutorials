...
// console.log(User.name, User.age); // suhrob 19
// console.log(User[19]); // age
// console.log(User[User.age]); // age
// console.log(User[User.name]); // error
// console.log(User["Suhrob"]); // error
// chunki biz key orqali valueni olishimiz mumkin lekin number typedan bolmagan boshqa type yoki value orqali keyni ololmaymiz

// console.log(Gender.Male, Gender.Female); // 2, 2
// yana bir yoli const bilan elon qilishi
const enum I {
  A, // 0
  B, // 1
  C = 5, // 5
...
let f: number[] | string[] = ["w"]; // bunda yo array number yoki string array bolishi kerak
// let tt: Array<number | string> = [1, 2, 3, '55'] // bunda array ichida number hm string ham kiritsa boladi
let tt: (number | string)[] = [1, 2, 3, "55"]; // bunda array ichida number hm string ham kiritsa boladi
